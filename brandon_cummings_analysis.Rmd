...
```{r}
plot(data$deathRate ~ data$popEst2015)
plot(data$deathRate ~ data$AvgHouseholdSize)
plot(data$deathRate ~ data$PercentMarried)
# have trouble with plot(data$deathRate ~ data$Geography), you can convert to utf-8  <- iconv(data$Geography, to='UTF-8', sub='')
plot(data$deathRate ~ data$avgAnnCount)
plot(data$deathRate ~ data$BirthRate)
